...
def main():
    ...
    # ── Step 1 — AI Analysis & Report
    print("\n" + "═" * 60)
    print("  STEP 1 / 3 — AI Data Analysis")
    print("═" * 60)
    from pre_process import run_analysis
    report_path = run_analysis(df, target, task_type, PROJECT_DIR)
    print(f"[SAVED] Report saved -> {report_path}")

    # ── Step 2 — AI Preprocessing & Clean Dataset
    print("\n" + "═" * 60)
    print("  STEP 2 / 3 — AI Preprocessing")
    print("═" * 60)
    from data_processing import run_preprocessing
    clean_df, plan, review = run_preprocessing(df, target, task_type, report_path, PROJECT_DIR)
